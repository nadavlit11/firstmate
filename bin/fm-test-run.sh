...
family_for_basename() {
  case "$1" in
    ...
    fm-send-secondmate-marker.test.sh|fm-shared-captain-inheritance.test.sh)
      printf '%s\n' secondmate
      ;;
    fm-backlog-atomicity.test.sh|fm-jobs.test.sh|\
...
# slowest retained value across several CI runs, so the balance holds on a slow
...
tests/fm-afk-pi-herdr-return-e2e.test.sh 105
tests/fm-afk-return.test.sh 1837
tests/fm-ask-user-authority.test.sh 128
tests/fm-backend-cmux-smoke.test.sh 94
tests/fm-backend-cmux.test.sh 3714
tests/fm-backend-orca.test.sh 19253
tests/fm-backend-tmux-smoke.test.sh 749
...
tests/fm-bearings-board-render.test.sh 1866
tests/fm-bearings-board.test.sh 5608
tests/fm-bearings-snapshot.test.sh 117763
tests/fm-bootstrap-network-parallel.test.sh 9422
tests/fm-bootstrap.test.sh 25208
tests/fm-branch-supervision.test.sh 24425
tests/fm-busy-adapter-wiring.test.sh 23477
tests/fm-busy-state.test.sh 2955
tests/fm-calm-pi-extension.test.sh 325
tests/fm-check-unregister.test.sh 494
tests/fm-classify-corr-token.test.sh 38742
tests/fm-classify-decision-key.test.sh 1182
tests/fm-claude-stop-autoarm-live-e2e.test.sh 41
tests/fm-claude-stop-autoarm.test.sh 60710
tests/fm-claude-trust.test.sh 7142
...
tests/fm-control-relaunch.test.sh 62161
tests/fm-control.test.sh 52707
tests/fm-crew-model-config.test.sh 28645
tests/fm-cursor-harness.test.sh 30233
tests/fm-cursor-primary-live-e2e.test.sh 22
tests/fm-cursor-primary.test.sh 55351
tests/fm-daemon.test.sh 27219
tests/fm-documentation-audiences.test.sh 771
tests/fm-extension-binding.test.sh 21942
tests/fm-fleet-snapshot-view.test.sh 8547
tests/fm-fleet-sync.test.sh 37749
tests/fm-gate-refuse.test.sh 5314
tests/fm-gemini-harness.test.sh 704
...
tests/fm-guard-stale-banner.test.sh 11899
...
tests/fm-herdr-session-cleanup.test.sh 8003
tests/fm-herdr-submit-confirm-live-e2e.test.sh 60
tests/fm-herdr-version-floor-live-e2e.test.sh 23
tests/fm-home-summary-refresh.test.sh 35607
tests/fm-inactive-reconcile.test.sh 73191
tests/fm-jobs.test.sh 6996
tests/fm-kimi-harness.test.sh 18457
tests/fm-lint-workflows.test.sh 2440
tests/fm-merge-local-base.test.sh 1831
tests/fm-muse-harness.test.sh 55572
tests/fm-muse-signals-live-e2e.test.sh 25
tests/fm-no-mistakes-required.test.sh 370
tests/fm-on.test.sh 11805
tests/fm-opencode-primary-live-e2e.test.sh 62
tests/fm-operational-input.test.sh 231
tests/fm-peek-remote.test.sh 1018
tests/fm-pending-reply.test.sh 30526
tests/fm-pi-branch-extension.test.sh 167806
...
tests/fm-remote-entrypoint.test.sh 437
tests/fm-remote-job-orphan-reap.test.sh 2973
tests/fm-remote-job.test.sh 59603
tests/fm-remote-reply.test.sh 101690
tests/fm-remote-secondmate-lifecycle-e2e.test.sh 229297
tests/fm-remote-secondmate-parent-binding.test.sh 32362
tests/fm-remote-secondmate-trace-context.test.sh 67096
tests/fm-remote-transport-lanes.test.sh 64075
tests/fm-secondmate-harness.test.sh 152124
tests/fm-secondmate-lifecycle-e2e.test.sh 10501
tests/fm-secondmate-liveness.test.sh 18146
tests/fm-secondmate-reconcile.test.sh 97934
tests/fm-secondmate-restart.test.sh 98486
tests/fm-secondmate-safety.test.sh 57689
tests/fm-secondmate-sync.test.sh 61228
tests/fm-send-inbox-doorbell-live-e2e.test.sh 22
tests/fm-send-inbox.test.sh 39311
tests/fm-send-remote-delivery.test.sh 29229
tests/fm-send-resolve-key.test.sh 30782
tests/fm-send-secondmate-marker-herdr-e2e.test.sh 51
tests/fm-send-secondmate-marker.test.sh 17592
tests/fm-session-lock-ancestry.test.sh 4106
tests/fm-session-start.test.sh 158332
...
tests/fm-stow-cascade.test.sh 5551
tests/fm-subagent-pretool-check.test.sh 1083
...
tests/fm-test-fixtures.test.sh 543
tests/fm-test-isolation-proof.test.sh 7164
tests/fm-tmux-agent-liveness.test.sh 2985
tests/fm-tool-update-check.test.sh 26492
tests/fm-trace-context-lib.test.sh 244
tests/fm-trace-context-spawn.test.sh 46637
tests/fm-turnend-guard.test.sh 42565
tests/fm-update.test.sh 9620
tests/fm-vendor-auth-probe.test.sh 43413
tests/fm-voice-relay.test.sh 28940
tests/fm-wake-daemon-lifecycle-e2e.test.sh 7642
tests/fm-wake-drain-open-decisions-cursor.test.sh 30551
tests/fm-wake-drain-open-decisions.test.sh 7400
tests/fm-wake-drain-outcome-backstop.test.sh 45246
tests/fm-wake-drain-unread-status.test.sh 35078
tests/fm-wake-queue.test.sh 69400
tests/fm-watch-arm.test.sh 72914
tests/fm-watch-checkpoint.test.sh 5901
tests/fm-watch-recovery-loop.test.sh 58855
tests/fm-watch-triage.test.sh 372097
...
families_for_changed_path() {
  ...
  case "$path" in
    ...
    docs/configuration.md|docs/supervision-protocols/*)
      printf '%s\n' pure-contract-unit
      ;;
    tests/lib.sh|tests/*-helpers.sh|tests/fixtures.sh|tests/*-stub-server.py)
