...
spawn_from_launcher "" "$PRIMARY_HOME" uniqA "$PROJ" --base main --mode no-mistakes --yolo off
...
spawn_from_launcher "$LAUNCH_PRIMARY_PANE" "$PRIMARY_HOME" uniqB "$PROJ" --base main --mode no-mistakes --yolo off
...
spawn_from_launcher "$LAUNCH_PRIMARY_PANE" "$PRES_HOME" presU "$PROJ" --base main --mode no-mistakes --yolo off
...
spawn_from_launcher "$LAUNCH_DUP_PANE" "$PRES_HOME" presD "$PROJ" --base main --mode no-mistakes --yolo off
...
spawn_from_launcher "" "$PRIMARY_HOME" dupD "$PROJ" --base main --mode no-mistakes --yolo off
...
spawn_from_launcher "$STALE_PANE" "$PRIMARY_HOME" staleF "$PROJ" --base main --mode no-mistakes --yolo off
...
spawn_from_launcher "$LAUNCH_SM_PANE" "$SM_HOME" smE "$PROJ" --base main --mode no-mistakes --yolo off
